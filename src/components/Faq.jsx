    ...
    <Container fluid id="faq" className="pt-5">
      <Row className="m-5">
        <Col lg={6}>
          ...
          <p>Kamu bisa menemukan jawaban dari pertanyaan mu disini guys.</p>
        </Col>
        <Col lg={6}>
          <Accordion className="mb-3">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                ...
                debitis ratione ut alias maiores eligendi possimus libero ex nulla. Commodi
                doloremque impedit natus quaerat fugit culpa qui iste vitae.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
          <Accordion className="mb-3">
